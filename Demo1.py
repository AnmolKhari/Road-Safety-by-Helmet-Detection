...
confThreshold = 0.5  # Confidence threshold value
# Non-maximum suppression threshold value used to increase the sensitivity
nmsThreshold = 0.4
inpWidth = 416  # Width of network's input image
inpHeight = 416  # Height of network's input image

classesFile = "obj.names"  # This file contain "Helmet" as our Object
